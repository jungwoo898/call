...
class ConsultationClassifier:
    ...
    def text_classify_by_keywords(self, text: str) -> ConsultationClassification:
        """키워드 기반 분류"""
...
"""
    ...
    def text_get_classification_summary(self, classification: ConsultationClassification) -> Dict[str, Any]:
        """분류 결과 요약"""
        return {
